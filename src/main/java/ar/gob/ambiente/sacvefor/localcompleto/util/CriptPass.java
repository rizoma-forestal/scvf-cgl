...
/**
 * Clase utilitaria para encriptar y desencriptar contraseñas para los usuarios a validarse en la API REST
 * @author rincostante
 */
public class CriptPass {
     ...
     * @throws Exception Excepción a ejecutar
     */
    public static String desencriptar(String textoEncriptado) throws Exception {
 
        String secretKey = ResourceBundle.getBundle("/Bundle").getString("ClaveDesencriptar"); //llave para desencriptar datos
        String base64EncryptedString = "";
