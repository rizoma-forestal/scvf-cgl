...
public class UsuarioClient {
    ...
    public <T> T findByQuery_XML(Class<T> responseType, String cuit, String juris) throws ClientErrorException {
        WebTarget resource = webTarget;
        if (cuit != null) {
    ...
    public <T> T findByQuery_JSON(Class<T> responseType, String cuit, String juris) throws ClientErrorException {
        WebTarget resource = webTarget;
        if (cuit != null) {
            resource = resource.queryParam("cuit", cuit);
        }
